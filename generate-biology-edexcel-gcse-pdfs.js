// Targeted PDF generator for the Biology Edexcel GCSE (1BI0) notes folder only.
...
const FOLDER = 'notes-biology-edexcel-gcse';
const SUB_LABEL = 'Biology — Edexcel (GCSE 1BI0)';
const CONCURRENCY = 3;
