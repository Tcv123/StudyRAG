  ...
  const DIAG_TOPICS = {
    ...
    'Chemistry_OCR B': {
      ...
      topics: [
        ...
        { id: 'PL', name: 'Polymers and Life', sub: 'Amines, amino acids, optical isomerism, protein structure, polymers and nylons, NMR and structure determination' },
    ...
    'Economics_Edexcel B': {
      ...
      topics: [
        { id: '1.1', name: 'Scarcity, Enterprise, Markets & Consumers', sub: 'Spec 1.1 to 1.3 (plus 2.2 elasticities): scarcity, business objectives, enterprise, demand, supply, price mechanism, market research, segmentation, market mapping, differentiation, PED and YED' },
        ...
        { id: '2.1', name: 'Competitiveness, Productivity & Economic Performance', sub: 'Spec 2.1.3 to 2.1.5, 2.2.2, 2.2.3, 2.3 and 2.5 (plus 2.4.2): R&D and innovation, the product life cycle, the digital economy, how small firms compete, pricing strategies, non-price competition, productivity, lean production, the economic cycle, inflation, unemployment and GDP' },
        ...
        { id: '4.1', name: 'Competition & Market Power', sub: 'Spec 4.1 and 4.2 (plus 2.1 growth): market structures, barriers, economies of scale, monopsony' },
        { id: '4.2', name: 'Market Failure, Policy Impact & Financial Risk', sub: 'Spec 4.3, 4.4 and 4.5: economy-wide market failure, macro policy impact on firms, risk and finance' },
      ],
    },
    'Economics_OCR': {
      label: 'Economics — OCR',
    ...
    'Further Mathematics_Edexcel': {
      ...
      topics: [
        ...
        { id: 'CP1.9', name: 'Vectors (Core Pure + FP1)', sub: 'Core Pure: lines, planes, scalar product, distances · FP1: vector and triple products' },
        ...
        { id: 'CP2.4', name: 'Volumes of Revolution (Core Pure + FP2)', sub: 'Core Pure: parametric volumes of revolution · FP2: arc length, surface area' },
    ...
    'Geography_Eduqas|gcse': {
      ...
      topics: [
        { id: '1.1', name: 'Urbanisation in Contrasting Global Cities', sub: 'Global patterns, two global cities, managing impacts' },
        { id: '1.2', name: 'Urban and Rural Processes and Change in the UK', sub: 'Urban zones, renewal, rural change, retail, leisure' },
        { id: '1.3', name: 'A Global Perspective on Development Issues', sub: 'Measuring development, globalisation, MNCs, trade, aid' },
        { id: '2.1', name: 'Coasts and Coastal Management', sub: 'Processes, landforms, management, SMPs, sea level rise' },
        { id: '2.2', name: 'Rivers and River Management', sub: 'Flows and stores, landforms, flooding, management' },
        { id: '2.3', name: 'Weather and Climate', sub: 'UK climate, global circulation, extreme weather events' },
        { id: '2.4', name: 'Climate Change — Cause and Effect', sub: 'Quaternary change, causes, consequences, responses' },
        { id: '3.1', name: 'How Ecosystems Function', sub: 'Biomes, savanna, rainforest, food webs, UK ecosystem' },
        { id: '3.2', name: 'Ecosystems Under Threat', sub: 'Human use, damage, conservation, sustainable management' },
        { id: '3.3', name: 'Water Resources and Management', sub: 'Supply and demand, over-abstraction, transfer schemes' },
        { id: '3.4', name: 'Desertification', sub: 'Vulnerable environments, causes, stakeholders, strategies' },
      ],
    },
    'Geography_OCR': {
      label: 'Geography — OCR',
