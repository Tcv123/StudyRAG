  ...
  const DIAG_TOPICS = {
    ...
    'Economics_Edexcel B': {
      ...
      topics: [
        ...
        { id: '3.1', name: 'Globalisation, Trade & Global Business', sub: 'Globalisation, trade, exchange rates, trading blocs, MNCs and FDI' },
        { id: '3.2', name: 'Global Labour Markets, Inequality & Redistribution', sub: 'Migration, global labour supply, poverty, Lorenz curve and Gini, redistribution, aid' },
        { id: '4.1', name: 'Competition & Market Power', sub: 'Market structures, growth of firms, barriers to entry, pricing strategies, monopsony' },
        { id: '4.2', name: 'Market Failure, Policy Impact & Financial Risk', sub: 'Economy-wide market failure, macro policy impact on firms, risk, the financial sector' },
      ],
    },
    'Economics_OCR': {
      label: 'Economics — OCR',
