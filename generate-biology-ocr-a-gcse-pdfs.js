// Targeted PDF generator for the Biology OCR A GCSE (J247 Gateway) notes folder only.
...
const FOLDER = 'notes-biology-ocr-a-gcse';
const SUB_LABEL = 'Biology — OCR A (GCSE J247 Gateway)';
const CONCURRENCY = 3;
