...
const PHYSICS_AQA_GCSE_AI_FEEDBACK = {
  ...
  '4.1': [
    ...
    {
      q: 'Explain how thermal insulation in the walls and loft of a house reduces unwanted energy transfers and saves money.',
      marks: 9, command: 'Explain',
  ...
  '4.2': [
    ...
    {
      q: 'Explain the role of the National Grid in distributing electricity, including why high voltages are used for transmission.',
  ...
  '4.3': [
    ...
    {
      q: 'Describe how a student could determine the density of an irregularly shaped object, such as a small stone.',
      marks: 6, command: 'Describe',
      modelAnswer: 'First measure the mass of the stone using a top-pan balance, in grams or kilograms. Then fill a displacement (eureka) can with water until water starts to run out of the spout, and wait until it stops dripping. Place an empty measuring cylinder under the spout and carefully lower the stone into the can on a thread, so that it is fully submerged without splashing. The volume of water that flows into the measuring cylinder is equal to the volume of the stone; read it at eye level from the bottom of the meniscus. Calculate the density using density = mass ÷ volume, making sure the units match (g/cm³ or kg/m³). To improve accuracy, repeat the measurements and calculate a mean, and dry the stone before measuring its mass if it has been in water.'
    },
    {
      q: 'Explain the meaning of specific latent heat and how it differs between melting and boiling for a substance such as water.',
      marks: 9, command: 'Explain',
  ...
  '4.4': [
    ...
    {
      q: 'Evaluate the medical uses of radioactivity, considering both the benefits and the risks to patients and staff.',
      marks: 12, command: 'Evaluate',
    ...
    {
      q: 'Explain the dangers of contamination and irradiation, and the difference between them.',
      marks: 9, command: 'Explain',
  ...
  '4.5': [
    ...
    {
      q: 'Explain how vehicle safety features such as crumple zones, airbags and seatbelts reduce the force on a passenger in a crash.',
      marks: 9, command: 'Explain',
  ...
  '4.6': [
    ...
    {
      q: 'Describe the uses and possible dangers of microwaves, ultraviolet radiation and X-rays.',
      marks: 12, command: 'Describe',
  ...
  '4.7': [
    ...
    {
      q: 'Describe the uses of electromagnets in everyday devices and industry, and explain one advantage they have over permanent magnets.',
      marks: 9, command: 'Describe',
  ...
  '4.8': [
    ...
    {
      q: 'Evaluate the evidence for the Big Bang theory and how convincing it is as a model for the origin of the universe.',
      marks: 12, command: 'Evaluate',
