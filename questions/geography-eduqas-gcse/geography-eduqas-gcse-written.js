  ...
  '1.6': {
    ...
    red: [
      ...
      },
      {
        ...
        marks_scheme: 'Level 3 (7-8 marks): balanced discussion of climate change and human activity as causes, recognising their interaction, with a nuanced conclusion. Level 2 (4-6 marks): covers both causes but limited integration or examples. Level 1 (1-3 marks): basic points about one cause. Credit: Sahel rainfall decreased 25–40% since 1970s; overgrazing widely considered primary driver; deforestation increases erosion 50–100×; climate change and human activity interact and reinforce each other.'
      },
    ],
  },
  ...
  '2.2': {
    ...
    red: [
      ...
      },
      {
        ...
        marks_scheme: 'Level 3 (7-8 marks): balanced discussion of social and economic challenges with named examples and a nuanced conclusion about their interconnection. Level 2 (4-6 marks): covers both sides with some development. Level 1 (1-3 marks): basic points about one type of challenge. Credit: London inequality — Kensington life expectancy 10 years higher than Tower Hamlets; housing affordability (average London house ~£500k); Northern cities lag London in wages and productivity; economic and social challenges are deeply intertwined.'
      },
    ],
  },
    ...
    green: [
      {
        ...
        marks_scheme: '1 mark: HDI combines life expectancy, education (mean and expected years of schooling), and GNI per capita. 1 mark: produces score between 0 and 1 — above 0.8 is very high development (e.g. Norway 0.961); below 0.55 is low development.'
      },
      {
    ...
    green: [
      {
        ...
        marks_scheme: '1 mark: global average temperature has risen ~1.1°C since pre-industrial period; 2023 warmest year on record. 1 mark: retreating glaciers and ice sheets — Greenland losing ~280 billion tonnes/year; mountain glaciers retreated significantly.'
      },
      {
