    ...
    questions: [
      {
        ...
        options: ["A reference type such as an object/array in Java or C#", "A constant", "A local variable", "An integer passed normally in most languages"],
        answer: 0,
    ...
    questions: [
      {
        ...
        options: ["Binary search tree", "Sorted array", "Linked list", "Hash table"],
        answer: 3,
      ...
      },
      {
        ...
        options: ["Push only opening brackets; on closing bracket pop and check it matches", "Push only closing brackets", "Use two stacks, one per bracket type", "Push every character; pop at end"],
        answer: 0,
  ...
  '4.4': {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["Primality testing", "Program equivalence in general", "Rice's semantic property", "Halting Problem"],
        answer: 0,
    ...
    questions: [
      {
        ...
        options: ["0110 1011", "1011 0110", "1010 0110", "1011 1100"],
        answer: 1,
      ...
      },
      {
        ...
        options: ["Lossy quantisation", "Huffman coding", "Run-length encoding", "Dictionary coding"],
        answer: 2,
  ...
  '4.6': {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["De Morgan", "Commutation", "Absorption", "Distribution"],
        answer: 0,
    ...
    questions: [
      {
        ...
        options: ["Indirect", "Immediate", "Indexed", "Direct"],
        answer: 1,
      ...
      },
      {
        ...
        options: ["Doubling", "3x", "4x", "Halving"],
        answer: 2,
    ...
    questions: [
      {
        ...
        options: ["Integrity and confidentiality", "Accuracy", "Purpose limitation", "Storage limitation"],
        answer: 3,
  ...
  '4.10': {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["Foreign keys", "Null values", "Partial dependencies", "Transitive dependencies"],
        answer: 3,
