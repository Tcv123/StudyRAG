...
const PHYSICS_OCR_B_GCSE_AI_FEEDBACK = {
  ...
  'P1': [
    ...
    {
      q: 'Describe how radiation dose, measured in sieverts, is used to assess the risk of harm from ionising radiation.',
      marks: 9, command: 'Describe',
      modelAnswer: 'Ionising radiation can damage cells and DNA, so the risk of harm must be measured. Radiation dose, measured in sieverts (Sv), is a measure of the possible harm done to the body. It takes into account both the amount of radiation absorbed and the type of radiation, because different types cause different amounts of damage for the same energy absorbed: alpha radiation, for instance, ionises tissue much more densely than gamma radiation. Because 1 Sv is a very large dose, everyday doses are usually given in millisieverts (mSv). Radiation dose gives a much better measure of biological risk and is used to set safe exposure limits for radiation workers and to assess medical procedures. Background radiation contributes a few millisieverts per year, while specific tasks such as a chest X-ray or a flight at high altitude can be expressed as doses in millisieverts for comparison.'
    },
    {
