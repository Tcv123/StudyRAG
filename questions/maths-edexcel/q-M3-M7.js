...
const EDEXCEL_MCQ_M3_M7 = {
  ...
  M3: [
    ...
    },
    {
      ...
      options: ["g/2 m/s²", "2g m/s²", "0 m/s²", "g m/s²"],
      answer: 2, tier: "green"
    },
    {
      q: "A 3 kg particle is in equilibrium. The sum of vertical forces on it must equal:",
      options: ["29.4 N upward", "29.4 N downward", "9.8 N", "0 N"],
      answer: 3, tier: "green"
    },
    {
    ...
    },
    {
      ...
      options: ["3.92 m/s²", "7.84 m/s²", "5.88 m/s²", "9.8 m/s²"],
      answer: 2, tier: "amber"
    },
    {
      ...
      options: ["33.9 N", "39.2 N", "9.8 N", "19.6 N"],
      answer: 3, tier: "amber"
    },
    {
    ...
    },
    {
      ...
      options: ["4.9 m/s²", "5.88 m/s²", "3.675 m/s²", "9.8 m/s²"],
      answer: 2, tier: "amber"
    },
    {
      ...
      options: ["18.9 N", "6 N", "31.3 N", "24.9 N"],
      answer: 3, tier: "amber"
    },
    {
    ...
    // RED (6)
    {
      ...
      options: ["5.60 m/s²", "3.50 m/s²", "9.8 m/s²", "1.40 m/s²"],
      answer: 1, tier: "red"
    },
    {
    ...
    },
    {
      ...
      options: ["1.0 m/s² (upward)", "8.8 m/s² (downward)", "0 m/s²", "−1.0 m/s² (downward)"],
      answer: 3, tier: "red"
    },
    {
    ...
    },
    {
      ...
      options: ["3.54 m/s² (A moves down)","0.16 m/s² (A moves down)","−0.16 m/s² (A moves up)","0.22 m/s² (A moves down)"],
      answer: 1, tier: "red"
    },
    {
      ...
      options: ["(1.5i + 0.75j) m/s²", "(8i + 2j) m/s²", "(2i − 0.5j) m/s²", "(8i − 2j) m/s²"],
      answer: 2, tier: "red"
    }
  ],
  ...
  M4: [
    // GREEN (12)
    {
      ...
      options: ["4 N·m", "9 N·m", "15 N·m", "36 N·m"],
      answer: 3, tier: "green"
    },
    {
    ...
    },
    {
      ...
      options: ["9.8 N·m", "0 N·m", "49 N·m", "24.5 N·m"],
      answer: 1, tier: "green"
    },
    {
      q: "For a rigid body in static equilibrium, the sum of clockwise moments about any point must equal:",
      options: ["The weight of the body", "The sum of all forces", "The sum of anticlockwise moments about that point", "Zero"],
      answer: 2, tier: "green"
    },
    {
    ...
    },
    {
      ...
      options: ["Three: ΣFx = 0, ΣFy = 0, ΣFz = 0", "Two: ΣF = 0 and ΣM = 0", "One: ΣF = 0 only", "One: ΣM = 0 only"],
      answer: 1, tier: "green"
    },
    {
      ...
      options: ["The point of maximum moment", "The centre of mass", "The point where an unknown reaction acts", "The midpoint of the rod"],
      answer: 2, tier: "green"
    },
    {
    ...
    },
    {
      ...
      options: ["0.67 m", "1 m", "1.5 m", "2.25 m"],
      answer: 1, tier: "green"
    },
    {
      ...
      options: ["8 N·m","0.0625 N·m","4 N·m","16 N·m"],
      answer: 2, tier: "green"
    },
    ...
    // AMBER (12)
    {
      ...
      options: ["2.5 m", "1.9 m", "3.1 m", "2.3 m"],
      answer: 3, tier: "amber"
    },
    {
    ...
    },
    {
      ...
      options: ["It tips only if the child moves further out", "Yes, it tips — clockwise moment exceeds anticlockwise", "No, it is stable", "Cannot determine without more information"],
      answer: 1, tier: "amber"
    },
    {
    ...
    },
    {
      ...
      options: ["73.5 N", "26.8 N", "19.2 N", "53.5 N"],
      answer: 1, tier: "amber"
    },
    {
      ...
      options: ["Taking moments about R₁'s point of action", "Taking moments about R₂'s point of action", "Taking moments about the midpoint only", "ΣF = 0 and ΣM = 0 together"],
      answer: 2, tier: "amber"
    },
    {
      ...
      options: ["1.5 m from A","2.0 m from A","3.0 m from A","4.0 m from A"],
      answer: 3, tier: "amber"
    },
    {
    ...
    },
    {
      ...
      options: ["It becomes zero", "It increases", "It decreases", "It stays constant"],
      answer: 1, tier: "amber"
    },
    {
      q: "A 60 N force acts at 30° to a rod at a point 2 m from the pivot. What is the moment about the pivot?",
      options: ["30 N·m", "69.3 N·m", "60 N·m", "103.9 N·m"],
      answer: 2, tier: "amber"
    },
    ...
    // RED (6)
    {
      ...
      options: ["10 kg","7.5 kg","2.5 kg","5 kg"],
      answer: 3, tier: "red"
    },
    {
    ...
    },
    {
      ...
      options: ["147 N","274 N","217 N","228 N"],
      answer: 1, tier: "red"
    },
    {
  ...
  M5: [
    ...
    },
    {
      ...
      options: ["Multiply v by t", "Integrate v with respect to t", "Differentiate v with respect to t", "Divide v by t"],
      answer: 1, tier: "green"
    },
    {
      q: "A particle's acceleration is a = 2t. Its velocity is 5 m/s when t = 0. Find v when t = 3.",
      options: ["9 m/s", "11 m/s", "14 m/s", "18 m/s"],
      answer: 2, tier: "green"
    },
    {
      q: "The maximum displacement from the starting point occurs when:",
      options: ["a = 0", "s is largest numerically", "t is largest", "v = 0"],
      answer: 3, tier: "green"
    },
    {
    ...
    },
    {
      ...
      options: ["t = √3 s", "t = 1 s", "t = 2 s", "t = 3 s"],
      answer: 1, tier: "amber"
    },
    {
    ...
    },
    {
      ...
      options: ["6 m/s", "2 m/s", "√20 m/s", "4 m/s"],
      answer: 0, tier: "red"
    },
    {
  ...
  M6: [
    // GREEN (12)
    {
      ...
      options: ["0 m/s", "It decreases with time", "9.8 m/s", "15 m/s"],
      answer: 3, tier: "green"
    },
    {
    ...
    },
    {
      ...
      options: ["5 m/s", "10 m/s", "17.3 m/s", "20 m/s"],
      answer: 1, tier: "green"
    },
    {
      ...
      options: ["2.02 s", "0.71 s", "1.01 s", "0.51 s"],
      answer: 2, tier: "green"
    },
    {
      q: "The range formula for a projectile launched at speed u and angle θ on level ground is:",
      options: ["R = u²sinθ/g", "R = u²sin²θ/g", "R = 2u sinθ/g", "R = u²sin2θ/g"],
      answer: 3, tier: "green"
    },
    {
    ...
    },
    {
      ...
      options: ["The times of flight are equal", "sin(2×30°) = sin(2×60°) = sin 60°", "Both angles give the same height", "The horizontal velocities are equal"],
      answer: 1, tier: "green"
    },
    {
      q: "A ball is launched at 10 m/s at 90° (straight up). What is its maximum height? (g = 9.8)",
      options: ["9.8 m", "20 m", "5.10 m", "10 m"],
      answer: 2, tier: "green"
    },
    ...
    // AMBER (12)
    {
      ...
      options: ["30.4 m", "15.2 m", "45.0 m", "19.0 m"],
      answer: 3, tier: "amber"
    },
    {
    ...
    },
    {
      ...
      options: ["51.0 m", "63.8 m", "127.6 m", "31.9 m"],
      answer: 1, tier: "amber"
    },
    {
      ...
      options: ["61.2 m", "21.4 m", "42.9 m", "85.7 m"],
      answer: 2, tier: "amber"
    },
    {
      ...
      options: ["24.0 m/s", "35.3 m/s", "30.5 m/s", "40.0 m/s"],
      answer: 3, tier: "amber"
    },
    {
    ...
    },
    {
      ...
      options: ["2.47 s","3.91 s","2.34 s","4.66 s"],
      answer: 1, tier: "amber"
    },
    {
    ...
    },
    {
      ...
      options: ["12.3 m/s","18.6 m/s","15.0 m/s","20.0 m/s"],
      answer: 1, tier: "amber"
    },
    {
      ...
      options: ["3 m/s","√(144 − 81) ≈ 7.9 m/s","15 m/s","21 m/s"],
      answer: 2, tier: "amber"
    },
    ...
    // RED (6)
    {
      ...
      options: ["4.47 s","3.50 s","2.11 s","2.74 s"],
      answer: 3, tier: "red"
    },
    {
    ...
    },
    {
      ...
      options: ["−g / (u²cos²θ)", "−g / (2u²)", "−g / (2u²cos²θ)", "g / (2u²cos²θ)"],
      answer: 2, tier: "red"
    },
    {
  ...
  M7: [
    ...
    },
    {
      ...
      options: ["Zero", "Greater (friction adds to gravity component)", "Less (friction opposes gravity component)", "The same"],
      answer: 1, tier: "green"
    },
    {
    ...
    },
    {
      ...
      options: ["16.97 N", "19.6 N", "4.9 N", "9.8 N"],
      answer: 3, tier: "green"
    },
    {
    ...
    // AMBER (12)
    {
      ...
      options: ["1.47 m/s²", "3.21 m/s²", "5.62 m/s²", "8.03 m/s²"],
      answer: 1, tier: "amber"
    },
    {
    ...
    },
    {
      ...
      options: ["33.9 N", "26.4 N", "19.6 N", "6.8 N"],
      answer: 1, tier: "amber"
    },
    {
      ...
      options: ["59.2 N", "30 N", "38.7 N", "49 N"],
      answer: 2, tier: "amber"
    },
    {
      ...
      options: ["5.64 m/s² (ignoring friction)", "2.29 m/s²", "3.48 m/s²", "2.93 m/s²"],
      answer: 3, tier: "amber"
    },
    {
    ...
    },
    {
      ...
      options: ["Cannot determine", "Yes, B descends (drives A up slope)", "Yes, A slides down (drives B up)", "No, system is in equilibrium"],
      answer: 1, tier: "amber"
    },
    {
      ...
      options: ["1.27 m", "4.16 m", "2.04 m", "3.54 m"],
      answer: 2, tier: "amber"
    },
    {
      ...
      options: ["0 ≤ P ≤ 13.2 N","0 ≤ P ≤ 17.0 N","0 ≤ P ≤ 14.7 N","0 ≤ P ≤ 23.9 N"],
      answer: 3, tier: "amber"
    },
    {
    ...
    // RED (6)
    {
      ...
      options: ["a ≈ 2.45 m/s², A moves up", "System is in equilibrium", "a ≈ 0.38 m/s², A moves up", "a ≈ 0.38 m/s², A moves down"],
      answer: 1, tier: "red"
    },
    {
    ...
    },
    {
      ...
      options: ["μ = P/(mg)", "μ = (P cosα − mg sinα) / (mg cosα + P sinα)", "μ = (P sinα + mg cosα) / (P cosα)", "μ = (mg sinα) / (P cosα)"],
      answer: 1, tier: "red"
    },
    {
      ...
      options: ["a = 2.45 m/s², T = 27.3 N", "a = 0 m/s², T = 39.2 N", "a = 1.86 m/s², T = 31.8 N", "a = 3.92 m/s², T = 23.5 N"],
      answer: 2, tier: "red"
    }
  ]
};
