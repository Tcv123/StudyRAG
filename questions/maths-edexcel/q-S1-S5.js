...
const EDEXCEL_MCQ_S1_S5 = {
  ...
  S4: [
    ...
    { tier: 'amber', q: 'The mean of \\(B(n,p)\\) is 6 and variance is 4.2. Find n and p.', options: ['n = 10, p = 0.6', 'n = 6, p = 1', 'n = 20, p = 0.3', 'n = 12, p = 0.5'], answer: 2 },
    ...
    { tier: 'red', q: 'An archer hits a target with probability 0.7 per shot. How many shots must they take so that \\(P(\\text{at least one hit}) > 0.999\\)?', options: ['7', '5', '6', '8'], answer: 2 },
  ],
