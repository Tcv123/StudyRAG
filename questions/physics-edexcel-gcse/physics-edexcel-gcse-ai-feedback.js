...
const PHYSICS_EDEXCEL_GCSE_AI_FEEDBACK = {
  ...
  '12': [
    ...
    },
    {
      ...
      marks: 9, command: 'Discuss',
      modelAnswer: 'In a simple d.c. motor, a rectangular coil is placed between the poles of a permanent magnet and connected to a d.c. supply through a split-ring commutator. Current in the two long sides of the coil experiences forces in opposite directions due to the motor effect, and these forces produce a turning moment that rotates the coil. As the coil passes through the vertical, the commutator reverses the connections to the external circuit reversing the current in the coil so that the side of the coil next to each pole always carries current in the same direction, keeping the rotation going in one direction. In a loudspeaker, a coil attached to a paper cone sits in the field of a permanent magnet and carries an alternating audio current. The motor effect produces a force that pushes the coil and cone backwards and forwards in time with the signal, creating sound waves of the same frequency in the air. Both devices rely on the same fundamental interaction between current, field and force, but use it to produce continuous rotation in one case and oscillating motion in the other.'
    },
  ],
  ...
  '14': [
    ...
    {
      q: 'Describe how the particle model explains the pressure of a gas, and how the pressure changes when a fixed mass of gas is heated at constant volume or compressed at constant temperature.',
      marks: 9, command: 'Describe',
      modelAnswer: 'The particles of a gas are far apart and move rapidly in random directions. When they collide with the walls of their container they change direction, so a force is exerted on the walls; pressure is the total force of these collisions acting on each unit area of wall, and it acts at right angles to the surface. If the gas is heated at constant volume, the particles gain kinetic energy and move faster on average. They therefore hit the walls more often and each collision exerts a larger force, so the pressure increases; the average kinetic energy of the particles is proportional to the temperature in kelvin, and at absolute zero (0 K, about −273 °C) the particles would have minimum kinetic energy. If the gas is compressed at constant temperature, the particles keep the same average speed, but there are more particles in each unit of volume, so they hit each unit area of the walls more often and the pressure rises. For a fixed mass of gas at constant temperature, pressure × volume is constant (P₁V₁ = P₂V₂), so halving the volume doubles the pressure. If the gas is compressed quickly, work is done on the gas, which increases the kinetic energy of its particles and raises its temperature, as seen when a bicycle pump warms up.',
    },
  ],
  ...
  '15': [
    {
      ...
      marks: 9, command: 'Explain',
      modelAnswer: 'When a force is applied to an object, it may stretch or compress. Elastic deformation occurs when the object returns to its original shape and size once the force is removed; inelastic deformation occurs when it does not return fully and remains permanently changed. Springs and rubber bands deform elastically up to a certain limit; beyond their elastic limit they deform inelastically. Hooke\'s law states that the extension of a spring is directly proportional to the force applied, provided the limit of proportionality is not exceeded: force = spring constant × extension. On a force–extension graph this gives a straight line through the origin up to the limit of proportionality, with the gradient equal to the spring constant. Beyond the limit of proportionality the line curves and the spring no longer obeys Hooke\'s law, and beyond the elastic limit it is permanently deformed.'
    },
    {
