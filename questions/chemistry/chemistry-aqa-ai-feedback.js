...
const CHEMISTRY_AQA_AI_FEEDBACK = {
  ...
  'I1': [
    ...
    { q: 'Compare the uses of Group 2 compounds, including magnesium hydroxide in medicine, calcium hydroxide in agriculture, calcium oxide or carbonate in removing sulfur dioxide from flue gases, and barium sulfate in X-ray imaging, and explain the chemistry behind each use.', marks: 9, command: 'Compare' },
  ...
  'O1': [
    ...
    { q: 'Discuss the nucleophilic substitution reactions of halogenoalkanes with hydroxide ions, cyanide ions and ammonia, including the mechanism, conditions and the factors that affect the rate.', marks: 12, command: 'Discuss' },
  ...
  'O2': [
    ...
    { q: 'Describe the preparation of aromatic amines from benzene via nitrobenzene, and of aliphatic amines from halogenoalkanes and from nitriles, including reagents and conditions.', marks: 9, command: 'Describe' },
