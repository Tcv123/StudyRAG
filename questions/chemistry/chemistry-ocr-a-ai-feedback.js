...
const CHEMISTRY_OCR_A_AI_FEEDBACK = {
  ...
  'M2': [
    { q: 'Describe how the mass spectrum of an element is used to determine its relative atomic mass, and explain the meaning of the terms isotope and relative isotopic mass.', marks: 9, command: 'Describe' },
  ...
  'M3': [
    ...
    { q: 'Explain how the qualitative tests for carbonate, sulfate and ammonium ions are carried out, including why the carbonate test must be done before the sulfate test.', marks: 12, command: 'Explain' },
    { q: 'Describe the disproportionation reactions of chlorine with water and with cold dilute sodium hydroxide and explain the changes in oxidation state.', marks: 9, command: 'Describe' },
    ...
    { q: 'Compare the reactions of aqueous chloride, bromide and iodide ions with silver nitrate followed by aqueous ammonia, and explain how the observations identify each halide.', marks: 12, command: 'Compare' },
  ...
  'M4': [
    ...
    { q: 'Discuss the nucleophilic substitution of haloalkanes by hydroxide ions, including the mechanism, and explain how the rate of hydrolysis depends on the carbon-halogen bond enthalpy.', marks: 12, command: 'Discuss' },
  ...
  'M5': [
    ...
    { q: 'Compare the lattice enthalpies of different ionic compounds and explain how ionic charge and ionic radius affect their values.', marks: 9, command: 'Compare' },
    ...
    { q: 'Compare the ligand substitution reactions of the hexaaqua copper(II) ion with ammonia and with chloride ions, and of the hexaaqua chromium(III) ion with excess ammonia.', marks: 12, command: 'Compare' },
  ...
  'M6': [
    ...
    { q: 'Discuss the hydrolysis of esters under acidic and alkaline conditions and compare the reactions of acyl chlorides with water, alcohols, phenols, ammonia and amines.', marks: 12, command: 'Discuss' },
    ...
    { q: 'Describe how phenylamine is prepared from benzene in two steps, including the reagents and conditions for each step.', marks: 9, command: 'Describe' },
    { q: 'Discuss the methods used to form carbon-carbon bonds in organic synthesis, including the use of nitriles and Friedel-Crafts reactions.', marks: 12, command: 'Discuss' },
    { q: 'Explain how amino acids combine to form dipeptides and polypeptides, and describe how peptides and proteins are hydrolysed back to their amino acids.', marks: 12, command: 'Explain' },
    { q: 'Describe the reactions of the amine and carboxylic acid groups in amino acids with acids, alkalis and alcohols.', marks: 9, command: 'Describe' },
