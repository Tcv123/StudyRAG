...
const CHEMISTRY_EDEXCEL_AI_FEEDBACK = {
  ...
  'T6': [
    ...
    { q: 'Discuss the hydrolysis of esters under acidic and alkaline conditions, explaining why alkaline hydrolysis goes to completion and how it is used to make soap from fats and oils.', marks: 12, command: 'Discuss' },
    ...
    { q: 'Discuss the basicity of aliphatic and aromatic amines and explain the trend in terms of the availability of the lone pair on the nitrogen atom.', marks: 12, command: 'Discuss' },
    { q: 'Explain how amino acids combine to form peptides and proteins, and how acid hydrolysis followed by chromatography can be used to identify the amino acids present in a protein.', marks: 12, command: 'Explain' },
