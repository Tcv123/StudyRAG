...
(function () {
  ...
  const AI_FEEDBACK_BUNDLE_MAP = {
    ...
    'Biology_AQA':                ['questions/biology/biology-aqa-ai-feedback.js'],
    'Biology_Edexcel A':          ['questions/biology/biology-edexcel-a-ai-feedback.js'],
    'Biology_Edexcel B':          ['questions/biology/biology-edexcel-b-ai-feedback.js'],
    'Biology_OCR A':              ['questions/biology/biology-ocr-a-ai-feedback.js'],
    'Biology_OCR B':              ['questions/biology/biology-ocr-b-ai-feedback.js'],
    'Biology_AQA|gcse':           ['questions/biology/biology-aqa-gcse-ai-feedback.js'],
    'Biology_Edexcel|gcse':       ['questions/biology-edexcel-gcse/biology-edexcel-gcse-ai-feedback.js'],
  ...
  const AI_FEEDBACK_MAP = {
    ...
    'Biology_AQA':              () => typeof BIOLOGY_AQA_AI_FEEDBACK !== 'undefined' ? BIOLOGY_AQA_AI_FEEDBACK : null,
    'Biology_Edexcel A':        () => typeof BIOLOGY_EDEXCEL_A_AI_FEEDBACK !== 'undefined' ? BIOLOGY_EDEXCEL_A_AI_FEEDBACK : null,
    'Biology_Edexcel B':        () => typeof BIOLOGY_EDEXCEL_B_AI_FEEDBACK !== 'undefined' ? BIOLOGY_EDEXCEL_B_AI_FEEDBACK : null,
    'Biology_OCR A':            () => typeof BIOLOGY_OCR_A_AI_FEEDBACK !== 'undefined' ? BIOLOGY_OCR_A_AI_FEEDBACK : null,
    'Biology_OCR B':            () => typeof BIOLOGY_OCR_B_AI_FEEDBACK !== 'undefined' ? BIOLOGY_OCR_B_AI_FEEDBACK : null,
    'Biology_AQA|gcse':         () => typeof BIOLOGY_AQA_GCSE_AI_FEEDBACK !== 'undefined' ? BIOLOGY_AQA_GCSE_AI_FEEDBACK : null,
    'Biology_Edexcel|gcse':     () => typeof BIOLOGY_EDEXCEL_GCSE_AI_FEEDBACK !== 'undefined' ? BIOLOGY_EDEXCEL_GCSE_AI_FEEDBACK : null,
