// Targeted PDF generator for the Biology Edexcel IGCSE (4BI1) notes folder.
...
const FOLDER = 'notes-biology-edexcel-igcse';
const SUB_LABEL = 'Biology — Edexcel International GCSE (4BI1)';
const CONCURRENCY = 3;
